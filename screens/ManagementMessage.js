...
const ManagementMessage = ({ navigation }) => {
    ...
    const getManagementList = async () => {
        ...
        NetInfo.fetch().then((state) => {
            ...
            if (state.isConnected) {
                ...
                setIsLoading(true)
                let data = { slug: "management-message" }
                        ...
                        <>
                            <ScrollView>
                                <View style={{ paddingHorizontal: 20 }}>
                                    <Text style={{ fontWeight: "bold", color: "#1D3557", fontSize: 15, marginTop: 10 }}>{t('management-message')}</Text>
                                    <Image
