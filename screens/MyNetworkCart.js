...
const MyNetworkCart = (item,navigation,addFavorite,t) => {
      ...
      <Card  onPress={()=>{
        ...
        <View>
          ...
          <View style={{ flex: 1, marginStart: 10,marginTop:10 }}>
            ...
            <Text style={{ color: "#707070", fontWeight: "normal", fontSize: 11, }}>{item.description}</Text>
