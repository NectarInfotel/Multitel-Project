...
export default class ResetPasswordTwo extends Component {
    ...
    render() {
        ...
        <Text style={styles.highlight}>multitel@gmail.com</Text>
      </Text>
      ...
      <TouchableOpacity onPress={()=>navigation.navigate('CreatePassword')}><Text style={styles.button}>Confirm</Text></TouchableOpacity> 
