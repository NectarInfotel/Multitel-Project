...
import {
    KeyboardAvoidingView, SafeAreaView,Dimensions, Button, View, Image, StatusBar, StyleSheet, Text, TouchableOpacity, ScrollView, FlatList, TextInput
} from "react-native";
        ...
        <View>
            ...
            <View style={{ flex: 1, marginStart: 10, marginTop: 10 }}>
                <View style={{ flexDirection: "row", width: "100%", justifyContent: "space-between" }}>
                    <Text style={{ alignItems: "flex-start", flex: 1, color: "#1D3557", fontWeight: "bold", fontSize: 14, }}>{item.name}</Text>
